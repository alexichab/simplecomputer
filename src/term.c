...
int
mt_getscreensize (
    int *rows, int *cols) // получает размер экрана терминала (количество строк и столбцов)
{
  struct winsize ws;
...
int
mt_setfgcolor (enum colors color) // устанавливает цвет фона для всех строк и столбцов всего терминала
{
  char foreground[30];
...
int
mt_setbgcolor (
    enum colors color) //устанавливает цвет фона только для предстоящих символов
{
  char background[30];
